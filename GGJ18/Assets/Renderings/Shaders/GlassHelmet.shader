...
////// Emissive:
                ...
                float3 node_9887 = pow(_BRDF_var.rgb,2.0);
                float3 emissive = node_9887;
                float3 finalColor = emissive;
                fixed4 finalRGBA = fixed4(finalColor,max(length(node_9887),_Alpha));
