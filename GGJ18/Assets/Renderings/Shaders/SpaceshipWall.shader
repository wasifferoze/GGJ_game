    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.pos = UnityObjectToClipPos( float4(v.vertex.xyz + v.normal*_Oultine,1) );
